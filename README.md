...
->I have used tailwind CSS to apply styling to the webapp
->If you encounter an error related to a missing module, you can try resolving it by running 
'npm install next' and then running 'npm run dev'
